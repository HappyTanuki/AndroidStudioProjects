                        ...
                        0 ->
                            mutableListOf<MutableState<Beverage>>(
                                ...
                                mutableStateOf<Beverage>( Coffee(
                                    ...
                                    mutableStateOf<String>("콜드 브루 몰트"),
                                    mutableStateOf<Int>(1),
                        ...
                        5 ->
                            mutableListOf<MutableState<Beverage>>(
                                mutableStateOf<Beverage>( Coffee(
                                    ...
                                    mutableStateOf<String>("딸기 아사이 레모네이드 스타벅스 리프레셔"),
                                    mutableStateOf<Int>(1),
                                ...
                                mutableStateOf<Beverage>( Coffee(
                                    ...
                                    mutableStateOf<String>("망고 용과 레모네이드 스타벅스 리프레셔"),
                                    mutableStateOf<Int>(1),
